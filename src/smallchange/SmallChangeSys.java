...
public class SmallChangeSys {
    ...
    public static void main(String[] args) {
        ...
        do {//do-while循环，先输出菜单，然后接收输入的数字传入switch里，在switch里写上1,2,3,4，的内容名称
            System.out.println("\n==============零钱通菜单===============");
            ...
            key = scanner.next();//接收用户的选择

            //使用switch分支控制
            switch (key) {
                case "1":
                    System.out.println(details);//一开始只有一行零钱通明细，通过拼接其他变量到details上，打印零钱通明细的完整内容
                    break;
                case "2":
